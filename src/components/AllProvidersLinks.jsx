...
const AllProvidersLinks = ({ image, provider, providerDesc,onPressHandler }) => {
  return (
    <>
      <TouchableOpacity onPress={onPressHandler}>
        <View style={tw`flex-row items-center px-2`}>
          ...
          <View style={tw`px-4 flex-1`}>
            <Text style={tw`text-white font-bold text-xl`}>{provider}</Text>
            <Text style={tw`text-white font-semibold`}>{providerDesc}</Text>
          </View>
        </View>
